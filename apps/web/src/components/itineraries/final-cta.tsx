...
export default function ItinerariesFinalCTA() {
	return (
		<section className="relative min-h-[80vh] overflow-hidden bg-foreground text-background">
			...
			/>
			<div className="absolute inset-0 bg-[linear-gradient(90deg,oklch(0.153_0.006_107.1/0.92)_0%,oklch(0.153_0.006_107.1/0.62)_50%,oklch(0.153_0.006_107.1/0.24)_100%)]" />
			...
			<div className="relative z-10 mx-auto grid min-h-[80vh] max-w-[1500px] grid-cols-1 items-center gap-12 px-6 py-24 sm:px-10 lg:grid-cols-12">
				<div className="lg:col-span-8 lg:col-start-2">
					...
					<StaggerText
						as="h2"
						className="max-w-5xl font-heading text-[clamp(3.6rem,9vw,9rem)] text-background leading-[0.84] tracking-[-0.055em]"
						delay={0.1}
						text="Tell us the Rajasthan you keep imagining"
					/>
				</div>
				...
				<div className="lg:col-span-4 lg:col-start-8 lg:self-end lg:pb-16">
					<ScrollReveal delay={0.2}>
						<p className="max-w-md border-background/18 border-t pt-6 font-sans text-background/72 text-base leading-relaxed md:text-lg">
							Every itinerary on this page can be reshaped. Tell us what you
							want more of, what you want to avoid, and how much quiet the trip
							should protect.
						</p>
					</ScrollReveal>
